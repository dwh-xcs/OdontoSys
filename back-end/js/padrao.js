...
//dim_pessoa
insertData('dim_pessoa', [1, '1', '1', 'Rogério Ceni', '11111111111', 'Não pode realizar procedimentos com anestesia local devido a reação alérgica', '11990000001', 'rogerioceni@saopaulofc.com', 'rceni', 'senha123', '1973-01-22', 'Mito do São Paulo FC', 'PACIENTE', 1]);
insertData('dim_pessoa', [2, '2', '2', 'Raí', '22222222222', 'Nenhuma', '11990000002', 'rai@saopaulofc.com', 'rai', 'senha123', '1965-05-15', 'Capitão mundial', 'PACIENTE', 1]);
insertData('dim_pessoa', [3, '3', '3', 'Careca', '33333333333', 'Restrição para extração de dentes devido a condições médicas', '11990000003', 'careca@saopaulofc.com', 'careca', 'senha123', '1960-10-05', 'Artilheiro histórico', 'PACIENTE', 1]);
insertData('dim_pessoa', [4, '4', '4', 'Müller', '44444444444', 'Nenhuma', '11990000004', 'muller@saopaulofc.com', 'muller', 'senha123', '1966-01-31', 'Atacante campeão', 'PACIENTE', 1]);
insertData('dim_pessoa', [5, '5', '5', 'Cafu', '55555555555', 'Evitar uso de aparelhos ortodônticos devido a histórico de lesões bucais', '11990000005', 'cafu@saopaulofc.com', 'cafu', 'senha123', '1970-06-07', 'Capitão do Penta', 'PACIENTE', 1]);
insertData('dim_pessoa', [6, '7', '6', 'Kaká', '66666666666', 'Nenhuma', '11990000006', 'kaka@saopaulofc.com', 'kaka', 'senha123', '1982-04-22', 'Melhor do Mundo', 'PACIENTE', 1]);
insertData('dim_pessoa', [7, '8', '7', 'Diego Lugano', '77777777777', 'Não pode realizar clareamento dental devido a sensibilidade extrema nos dentes', '11990000007', 'lugano@saopaulofc.com', 'lugano', 'senha123', '1980-11-02', 'Zagueiro ídolo uruguaio', 'PACIENTE', 1]);
insertData('dim_pessoa', [8, '9', '8', 'Hernanes', '88888888888', 'Nenhuma', '11990000008', 'hernanes@saopaulofc.com', 'hernanes', 'senha123', '1985-05-29', 'O Profeta', 'PACIENTE', 1]);
insertData('dim_pessoa', [9, '9', '9', 'Leonardo', '99999999999', 'Deve evitar tratamentos estéticos (ex: facetas) devido a problemas periodontais graves', '11990000009', 'leonardo@saopaulofc.com', 'leonardo', 'senha123', '1969-09-05', 'Lateral e dirigente', 'PACIENTE', 1]);
insertData('dim_pessoa', [10, '10', '10', 'Toninho Cerezo', '10101010101', 'Nenhuma', '11990000010', 'toninhocerezo@saopaulofc.com', 'tcerezo', 'senha123', '1955-04-21', 'Volante campeão', 'PACIENTE', 1]);

//ft_agenda
insertData('ft_agenda', [1, 1, 10, 'Consulta inicial - Avaliação odontológica', 1, '2025-05-10', '14:00']);
insertData('ft_agenda', [2, 2, 12, 'Profilaxia (limpeza dentária)', 1, '2025-05-11', '10:30']);
insertData('ft_agenda', [3, 3, 1, 'Tratamento de canal - Pré-molar', 1, '2025-05-12', '09:00']);
insertData('ft_agenda', [4, 4, 4, 'Clareamento dental - Sessão 1', 1, '2025-05-13', '11:00']);
insertData('ft_agenda', [5, 5, 5, 'Instalação de aparelho ortodôntico', 1, '2025-05-14', '15:00']);
insertData('ft_agenda', [6, 6, 6, 'Consulta de revisão ortodôntica', 1, '2025-05-15', '16:30']);
insertData('ft_agenda', [7, 7, 9, 'Extração de dente siso', 1, '2025-05-16', '13:00']);
insertData('ft_agenda', [8, 8, 11, 'Colocação de prótese dentária', 1, '2025-05-17', '08:30']);
insertData('ft_agenda', [9, 9, 10, 'Restauração de cárie - Molar superior', 1, '2025-05-18', '17:00']);
insertData('ft_agenda', [10, 10, 7, 'Avaliação para implante dentário', 1, '2025-05-19', '12:00']);